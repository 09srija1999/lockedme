 ...
 class FileOperation
 {
	 ...
	 public static void operation() throws IOException
	 {
		 ...
		 do 
		 {
			 ...
			 System.out.println("1. Retrieve All Files from Folder");
